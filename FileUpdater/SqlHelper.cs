...
namespace FileUpdater
{
    ...
    internal class SqlHelper
    {
        ...
        private static string dateIp = FileUpdater.Properties.Resources.IP;
        private static string dateName = FileUpdater.Properties.Resources.dateName;
        private static string dateUser = FileUpdater.Properties.Resources.user;
        private static string datePwd = FileUpdater.Properties.Resources.pwd;

        private static readonly string connectionString = string.Format("Data Source={0};Pooling=False;Max Pool Size = 1024;Initial Catalog={1};Persist Security Info=True;User ID={2};Password={3}",
